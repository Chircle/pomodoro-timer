...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      {
        url: `${base}/favicon/favicon-16x16.png`,
        sizes: '16x16',
        type: 'image/png',
      },
      {
        url: `${base}/favicon/favicon-32x32.png`,
        sizes: '32x32',
        type: 'image/png',
      },
      {
        url: `${base}/favicon/favicon.ico`,
        sizes: 'any',
      },
    ],
    apple: `${base}/favicon/apple-touch-icon.png`,
    other: [
      {
        rel: 'android-chrome-192x192',
        url: `${base}/favicon/android-chrome-192x192.png`,
      },
      {
        rel: 'android-chrome-512x512',
        url: `${base}/favicon/android-chrome-512x512.png`,
      },
    ],
  },
}
